...
var instrucciones = ["Mover las piezas con las flechas del teclado", "Ordenarlas en forma correcta"];
...
function mostrarInstrucciones(instrucciones) {
    ...
    for (var index = 0; index < instrucciones.length; index++) {
        mostrarInstruccionEnLista(instrucciones[index], idLista);
    }
}
